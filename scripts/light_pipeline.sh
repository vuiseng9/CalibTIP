...
scripts/adaquant.sh $model $model_vis 4 4 false
scripts/adaquant.sh $model $model_vis 8 8 false
scripts/integer-programing.sh $model $model_vis 4 4 8 8 50 loss false
...
do
   ...
   scripts/bn_tuning.sh resnet resnet50 8 8 $cfg_idx false
done
